...
export default function Home() {
  ...
  return (
    ...
    >
      <section className="relative isolate pt-8 w-full rounded-3xl bg-[#DDD7FF]" id="hero" >
        ...
        <div className="pt-8 w-full flex flex-col items-center">
          <div className="flex flex-col md:flex-row justify-around border-t-1 border-divider">
            ...
            <div className="flex flex-col gap-2 p-9 items-start">
              ...
              <h4 className="text-base text-divider/60">Our intuitive dashboard is
                designed to lower your time
                managing your affiliate program.</h4>
            </div>
            <div className="relative hidden md:inline-block md:h-[480px]">
              <div className="absolute h-full p-[0.5px] -left-[0.5px] bg-gradient-to-b from-divider to-divider/0 border-transparent"></div>
              <div className="absolute w-[22px] h-[22px] -top-[11px] -left-[11px] border-1 shadow-md rounded-full bg-white dark:bg-[#242424] border-divider">
            ...
            <div className="flex flex-col gap-2 p-9 items-start">
              ...
              <h3 className="text-xl font-semibold">Fixed Commission or
                Percentage</h3>
              <h4 className="text-base text-divider/60">Offer your affiliates a percentage
                of your program plans or a fixed
                commission for every paid sign-up.</h4>
            </div>
            <div className="relative hidden md:inline-block md:h-[480px]">
              <div className="absolute h-full p-[0.5px] -left-[0.5px] bg-gradient-to-b from-divider to-divider/0 border-transparent"></div>
              <div className="absolute w-[22px] h-[22px] -top-[11px] -left-[11px] border-1 shadow-md rounded-full bg-white dark:bg-[#242424] border-divider">
            ...
            <div className="flex flex-col gap-2 p-9 items-start">
              ...
              <h3 className="text-xl font-semibold">Thousands Affiliate
                Programs</h3>
              <h4 className="text-base text-divider/60">Discover thousand of affiliate
                programs for a lifetime. Never
                worry about expiration dates or
                subscription renewals.</h4>
            </div>
            <div className="relative hidden md:inline-block md:h-[480px]">
              <div className="absolute h-full p-[0.5px] -left-[0.5px] bg-gradient-to-b from-divider to-divider/0 border-transparent"></div>
              <div className="absolute w-[22px] h-[22px] -top-[11px] -left-[11px] border-1 shadow-md rounded-full bg-white dark:bg-[#242424] border-divider">
      ...
      <section className="relative isolate pt-30 w-full rounded-3xl" id="hero" >
        <div className="flex flex-col items-center gap-4 max-w-xl mx-auto">
          ...
          <div className="text-center">
            <h1 className="text-[40px] font-semibold">Discover the Trending Niches</h1>
            <span className="font-medium text-divider/30 text-base">Hundreds of Affiliate Program Niches ready to explore! </span>
          </div>
        </div>
      ...
      <section className="relative isolate pt-40 w-full rounded-3xl" id="hero" >
        <div className="flex flex-col items-center gap-4 max-w-xl mx-auto">
          ...
          <div className="text-center">
            <h1 className="text-[40px] font-semibold">People just like you
              are already using Referalio</h1>
          </div>
        </div>
      ...
      <section className="relative isolate pt-40 w-full rounded-3xl" id="hero" >
        <div className="flex flex-col items-center gap-4 max-w-xl mx-auto">
          ...
          <div className="text-center">
            ...
            <span className="font-medium text-divider/30 text-base">Get lifetime access to our app for a none-time price that won’t
              break the bank</span>
          </div>
        </div>
        <div className="flex flex-col md:flex-row gap-6 mt-8">
          <div className="flex flex-col gap-16 p-10 rounded-2xl border-1 border-divider shadow-sm h-90">
            <div className="flex-1">
              ...
              <span className="text-[15px] text-divider/50">Try it as long as you like</span>
          ...
          <div className="w-full flex flex-col gap-16 p-10 rounded-2xl bg-[#C0B4FE] h-90">
            ...
            <Button radius="full" size="lg" className="bg-[#F9F2FF] text-[#4E2D92] md:w-64">Choose plan ($45)</Button>
          </div>
        </div>
      </section>
    </section>
